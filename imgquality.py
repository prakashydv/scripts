# rewrites file with mentioned quality
#
# usage: > python imgquality.py "inputfile" "outputfile" Q
#
# note : outputfile arg is optional, on absence of this argument another fle with "_" postfix is written
#        Q must be in [0:100]
#        Fully qualified paths are acceptable
#
# example : > python imgquality.py "C:/sampleimage.jpg" "C:/lowquality.jpg" 20
